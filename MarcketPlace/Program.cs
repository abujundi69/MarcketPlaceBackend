...
builder.Services.Configure<TwilioVerifyOptions>(
...
using (var scope = app.Services.CreateScope())
{
    ...
    await DbInitializer.EnsureSystemStoreExistsAsync(db);
    await DbInitializer.EnsureDefaultDeliveryZoneExistsAsync(db);
    await DbInitializer.EnsureDefaultSystemSettingsExistsAsync(db);
}
